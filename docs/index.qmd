...
We used data from Our World in Data’s greenhouse gas emissions dataset, which compiles country-level data from sources like the Global Carbon Project and BP Statistical Review. The dataset covers emissions from fossil fuels, industry, and land-use change.
